...
crossroads = input('You\'re at a crossroads. Where do you want to go? Type "left" or "right"')
...
if lake.lower() == "swim":
  print("\nYou are attacked by trout and drown. Game Over.")
  exit()
...
if doors.lower() == "red":
  ...
  print("You are frozen ice. Game Over.")
  exit()
elif doors.lower() == "yellow":
  print("You found the treasure")
else:
  print("You die of old age searching for the right door.")